package com.itcunkou.lib.base.util;
...
public class DateUtils {
     ...
     * 缓存时间 s
     */
    public static int TIME_YEAR = 15552000;
    ...
    public static String getWeekday(String str, Context context) {
        try {
            ...
            if (date != null) {
                // 0..6 0:sunday,
                return weekdayFormat(date.getDay(), context);
            }
        } catch (ParseException e) {
        }
        return "";
    ...
    public static int getDaysBetween(Calendar endTime) {
        ...
        try {
            ...
            if (startTime.get(Calendar.YEAR) != y2) {
                ...
                do {
                    // 得到当年的实际天数
                    days += startTime.getActualMaximum(Calendar.DAY_OF_YEAR);
                    startTime.add(Calendar.YEAR, 1);
                } while (startTime.get(Calendar.YEAR) != y2);
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (day == 0) {
                ...
                if (sdf != null) {
                    ...
                    if (dayTime < 10) {
                        //formatTweetDetailTime(date, false);
                        return month + "月0" + dayTime + "日";
                    } else {
